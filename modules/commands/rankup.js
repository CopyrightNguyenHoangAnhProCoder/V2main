...
module.exports.event = async function({ api, event, Currencies, Users, client }) {
	...
	if (level > curLevel && level != 1) {
		...
		if (existsSync(__dirname + `/cache/rankup/rankup.gif`)) arrayContent = { body: messsage, attachment: createReadStream(__dirname + `/cache/rankup/rankup.gif`), mentions: [{ tag: nameUser, id: senderID }] };
